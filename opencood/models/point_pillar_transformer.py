...
from opencood.models.fuse_modules.fuse_utils import regroup, extract_ego
...
class PointPillarTransformer(nn.Module):
    def __init__(self, args):
        ...
        # if 'agent_cls' in args:
        #     self.agent_cls_flag = True
        #     self.agent_classifier = DAClsHead(256 + 2, -2)
    ...
    def forward(self, data_dict):
        ...
        #     agent_psm_single = self.da_avgpool(agent_psm_single)  # (B, H, W/2, A/2) (B, 48, 64, 1)
        ...
        #     domain_psm = self.da_avgpool(domain_psm)  # (B, H, W/2, A/2) (B, 48, 64, 1)
