...
def extract_ego(dense_feature, record_len):
    """
    Extract the ego feature from the dense feature.
    ...
    ego_features = [split_feature[0] for split_feature in split_features]

    # B, C, H, W
    ego_feature = torch.stack(ego_features)
